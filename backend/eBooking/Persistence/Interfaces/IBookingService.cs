...
namespace Persistence.Interfaces
{
    public interface IBookingService : IBaseService<BookingDto, CreateBookingDto, UpdateBookingDto>
    {
        ...
        Task<bool> CancelBookingAsync(int id, int? cancelledByUserId = null, string? reason = null);
        Task<bool> CheckInAsync(int id, int? checkedInByUserId = null);
        Task<bool> CheckOutAsync(int id, int? checkedOutByUserId = null);
        Task<bool> MarkNoShowAsync(int id, int? markedByUserId = null);
        ...
        Task<bool> ConfirmBookingAfterPaymentAsync(int bookingId, int paymentId);
    }
