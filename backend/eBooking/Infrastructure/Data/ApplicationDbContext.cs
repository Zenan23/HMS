...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Guest>(entity =>
        {
            ...
            entity.Property(g => g.FirstName).IsRequired().HasMaxLength(50);
            entity.Property(g => g.LastName).IsRequired().HasMaxLength(50);
            entity.Property(g => g.Email).IsRequired().HasMaxLength(100);
            entity.Property(g => g.PhoneNumber).HasMaxLength(20);
            entity.Property(g => g.Address).HasMaxLength(200);
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(u => u.Role).IsRequired().HasMaxLength(20).HasDefaultValue("Guest");
